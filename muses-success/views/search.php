                ...
                foreach ($keywords as $word)
                {
                 ...
                 foreach ($query->result() as $item)
                 {
                        if ($item->type == 'listing')
                        {
                                ...
                                $results[$i]['summary'] = '<small><a href="'.$listing->story_url.'">Read This</a> - '.$listing->story_primary_genre.' / '.((strlen($listing->story_secondary_genre) > 2) ? $listing->story_secondary_genre : $listing->story_primary_genre).' - '.$listing->story_review_count.' Reviews - Rated '.$listing->story_average_rating.' out of 10</small>';
                                ...
                                $results[$i]['summary'] = '<small>Review of <a href="'.site_url('browse/view/'.$listing->story_slug.'/').'">'.$listing->story_title.'</a> by '.$listing->story_author.' - Rated '.$review->review_rating.' out of 10</small>';
